...
## ソースコードの説明
l109-110:使用する変数を用意する

l112-114:visitedを初期化する

l116:スタックを初期化する

l117:出発点をプッシュする

l119:スタックが空になるまで繰り返す

l120:スタックから取り出す

l121-122:行ったことがあるか判断し、行ったことがなければ行ったことにする

l124:結果の表示

l126-128:その場所から行ける場所をスタックに入れる


l198-199:使用する変数を用意する

l201-202:visitedを初期化する

l204:キューを初期化する

l205:出発点をキューに入れる

l207:スタックが空になるまで繰り返す

l209-210:行ったことがあるか判断し、行ったことがなければ行ったことにする

l212:結果の表示

l214-216:その場所から行ける場所をキューに入れる
